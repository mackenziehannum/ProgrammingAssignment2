## This is for RProgramming Week 3 Assignment. I am creating functions to cache
## calculating the inverse of a matrix, to save on time. Through this we will
## take advantage of the lexical scoping rules
